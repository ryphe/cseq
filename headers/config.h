...
#define CSEQ_VERSION_STRING "1.34"
...
#define HALO_MAX_GLOBAL_VOICES 48
...
enum {
    ...
    ID_CLIP_SLICE = 1109,
    ID_CLIP_REVERSE = 1140,
    ID_TRACK_SC_NONE = 1150,
    ID_TRACK_SC_UNLINK = 1152,
    ID_TRACK_SC_BASE = 1200 // 1200..1200 + MAX_TRACKS
};
