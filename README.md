...
| **MIDI & Sequencing** | Full piano roll with note‑by‑note velocity, length, and pitch editing. Built‑in **Generative Sequencer** for chord/arp patterns (root, scale, note count). **Humanize** tool for timing/duration/velocity randomisation. Per‑track **trigger probability** (0‑100%) for sample/note events |
