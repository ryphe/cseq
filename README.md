...
| **FX Rack** | Modular drag‑and‑drop chain hosting up to 12 serial effects per track. Drag modules from the left pool into the chain; drag vertically to reorder slots; right‑click to remove. Click a slot to reveal bottom-strip parameter controls with live knob drags and mouse wheel support |
