...
| **UI & Workflow** | 120 FPS GDI pipeline with FNV hash‑tree dirty tracking for partial redraws. Content‑addressed PCM disk cache (FNV‑1a) deduplicates decoded audio. Media Explorer with loopable preview. Full **Undo/Redo** with whole‑struct snapshots |
