...
| **Granular Synthesis** | Interactive note grid and synthesis parameters (density, size, spray, detune, pan, ADSR envelope, freeze, drone). Supports track-level or clip-level engines, QWERTY audition, and octave shifting |
