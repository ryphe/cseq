...
:: The vendored libopus/libopusfile sources include "config.h" from their own
:: src/ dirs, but those paths are gitignored upstream (generated by configure),
:: so they never ship in the repo. Drop the committed configs in place here.
copy /y opus\config\opus_config.h opus\opus\src\config.h >nul
copy /y opus\config\opusfile_config.h opus\opusfile\src\config.h >nul
