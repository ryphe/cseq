...
call :COMPILE dsp_verify.c         "dsp_verify"         "/W3 /O2 /I.. /I..\headers /I..\opus"             "user32.lib gdi32.lib msimg32.lib"
call :COMPILE reverse_verify.c     "reverse_verify"     "/W3 /O2 /I.. /I..\headers /I..\opus"             "user32.lib gdi32.lib msimg32.lib"
call :COMPILE repro_halo.c         "repro_halo"         "/W3 /O2 /std:c17 /I.. /I..\headers /I..\opus"    "user32.lib gdi32.lib msimg32.lib"
...
call :COMPILE sidechain_verify.c   "sidechain_verify"   "/W3 /O2 /I.. /I..\headers /I..\opus"                    "user32.lib gdi32.lib msimg32.lib"
...
call :RUN sidechain_verify  "External sidechain ducking (slot-0 compressor)"
...
del /q adsr_verify.exe adsr_verify.obj ^
        ...
        sidechain_verify.exe sidechain_verify.obj ^
