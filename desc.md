...
- Trailing section structs: `CSQSynthSection`, `CSQFilterSection`, `CSQProbSection`, `CSQMasterSection`, `CSQTrackMixSection`.
...
- `load_audio_file`�decodes audio (via miniaudio, Media Foundation, or OGG) into the sample cache.
...
- Grid division enum, fade curve types, menu command IDs.
